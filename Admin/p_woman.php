...
<?php
      ...
      { 
            ...
            // FIX 3: Changed table name to 'products_woman'
            $q1 = "SELECT * FROM `products_woman` WHERE p_id = '$id'";
            $result = mysqli_query($con, $q1);
            
            if(!$result) {
                // For debugging if table name is wrong
         ...
         // FIX 4: Insert into 'products_woman'
         $q1 = "INSERT INTO `products_woman`(p_id, p_name, p_price, p_image, p_description) VALUES('$id', '$name', '$price', '$image', '$description')";
         $result = mysqli_query($con, $q1);
         ...
         if(!$result){
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    icon: 'success',
                    title:'Success!',
                    text: 'Women Product Added Successfully.',
                    showConfirmButton: false,
                    timer: 1500
                    }).then(() => {
